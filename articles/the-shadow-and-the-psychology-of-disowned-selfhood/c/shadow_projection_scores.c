...
Not for diagnosis, therapy, moral ranking, mental-health evaluation,
...
double integration_capacity(
    ...
    return 0.50 * reflective_capacity
         - 0.34 * fabs(projection_intensity_value)
         - 0.26 * shame_response
...
int main(void) {
    ...
    printf("Synthetic shadow activation: %.3f\n", shadow);
    printf("Synthetic projection intensity: %.3f\n", projection);
    printf("Synthetic integration capacity: %.3f\n", integration);
    return 0;
}
