...
ARTICLE_DIR = Path("articles/dreams-compensation-and-the-prospective-function")
DATA_PATH = ARTICLE_DIR / "data/raw/synthetic_dream_series.csv"
DICTIONARY_PATH = ARTICLE_DIR / "data/raw/dream_motif_dictionary.csv"
...
# ------------------------------------------------------------
# Motif family activation over time and by dream
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# Centrality change for prospective motifs
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# Dream-series type profiles
# ------------------------------------------------------------

series_type_profile = (
    motif_df.groupby(["dream_series_type", "motif_family"], as_index=False)["count"]
    .sum()
...
series_type_profile.to_csv(OUTPUT_DIR / "dream_series_type_motif_profile.csv", index=False)
...
print("\nDream-series type profile")
print(series_type_profile)
